...
\begin{block}{Contrôleurs graphiques}
  Apparus vers la fin des années 1980, ils apportent des fonctionnalités graphiques, comme le tracé de segment, 
...
\footnotesize  \centering
            ...
            \rowcolor{lightgray}\textbf{Année} & \textbf{Carte} & \textbf{Architecture} & \textbf{Cœurs} & \textbf{RAM} & \textbf{Puissance} \\\hline
